	...
	return {
		...
		load: function (name, parentRequire, load, config) {
			...
			fetchText(path, function (source) {
				...
				var compileDust = function (s) {
					var wrapStart = 'define(["dust-core"], function (dust) {';
					var body = dust.compile(s, path);
					var wrapEnd = 'return dust.render.bind(dust, "' + path + '");})';
					return wrapStart + body + wrapEnd;
				}
